...
const strings = {
  en: {
    ...
    demoHint: 'Demo: FCHV-1001 / 1234  ·  FCHV-1002 / 5678  ·  FCHV-1003 / 9012',
    ...
    assignPsychiatrist: 'Assign Psychiatrist',
    reassignPsychiatrist: 'Reassign',
    assignTitle: 'Assign a Psychiatrist',
    assignSubtitle: 'Select any psychiatrist — no appointment needed',
    unavailableNote: 'Currently unavailable',
    assignSuccess: 'Psychiatrist assigned',
    currentlyAssigned: 'Currently assigned',

    // Profile screen
    navProfile: 'Profile',
    profileTitle: 'My Profile',
    myAlerts: 'Patients Needing Attention',
    noActiveAlerts: 'No active alerts — great work!',
    viewAll: 'View All',
    memberSince: 'Volunteer Since',
    totalVisitsLabel: 'Total Visits',
    activeAlertsLabel: 'Active Alerts',
    criticalLabel: 'Critical',
    patientAlertsSub: 'High and critical risk patients from recent visits',
    followUpNeeded: 'Follow-up needed',

    // Consult self-support
    forPatient: 'Patient',
    forMyself: 'My Wellbeing',
    selfConsultTitle: 'Volunteer Support',
    selfConsultSub: "FCHV work is emotionally demanding. It's okay to reach out for support.",
    yourConcern: 'What\'s on your mind?',
    yourConcernPlaceholder: 'Describe what you\'re going through, or ask a question about a case...',
    consultPreviewLabel: 'What will be shared with the specialist:',
    sendRequest: 'Send Support Request',
    requestSent: 'Request Sent',
    requestSentDesc: 'A specialist will contact you during available hours. You are not alone.',
    sendAnon: 'Hide my name',
  },
  ne: {
    appName: 'AAMA सखी',
    ...
    demoHint: 'डेमो: FCHV-1001 / 1234  ·  FCHV-1002 / 5678  ·  FCHV-1003 / 9012',
    ...
    assignPsychiatrist: 'मनोचिकित्सक तोक्नुहोस्',
    reassignPsychiatrist: 'पुनः तोक्नुहोस्',
    assignTitle: 'मनोचिकित्सक तोक्नुहोस्',
    assignSubtitle: 'जुनसुकै समय — अपोइन्टमेन्ट आवश्यक छैन',
    unavailableNote: 'हाल अनुपलब्ध',
    assignSuccess: 'मनोचिकित्सक तोकियो',
    currentlyAssigned: 'हाल तोकिएको',

    // Profile screen
    navProfile: 'प्रोफाइल',
    profileTitle: 'मेरो प्रोफाइल',
    myAlerts: 'ध्यान दिनुपर्ने बिरामीहरू',
    noActiveAlerts: 'कुनै सक्रिय सूचना छैन — राम्रो काम!',
    viewAll: 'सबै हेर्नुहोस्',
    memberSince: 'स्वयंसेवक भएको',
    totalVisitsLabel: 'जम्मा भेट',
    activeAlertsLabel: 'सक्रिय सूचना',
    criticalLabel: 'गम्भीर',
    patientAlertsSub: 'हालका भेटबाट उच्च र गम्भीर जोखिमका बिरामीहरू',
    followUpNeeded: 'फलो-अप आवश्यक',

    // Consult self-support
    forPatient: 'बिरामी',
    forMyself: 'मेरो स्वास्थ्य',
    selfConsultTitle: 'स्वयंसेवक सहायता',
    selfConsultSub: 'FCHV कार्य भावनात्मक रूपमा माग गर्ने हुन्छ। सहयोग माग्नु राम्रो हो।',
    yourConcern: 'तपाईंको मनमा के छ?',
    yourConcernPlaceholder: 'तपाईं के अनुभव गर्दै हुनुहुन्छ वा कुनै केसबारे प्रश्न सोध्नुहोस्...',
    consultPreviewLabel: 'विशेषज्ञसँग साझा हुने जानकारी:',
    sendRequest: 'सहायता अनुरोध पठाउनुहोस्',
    requestSent: 'अनुरोध पठाइयो',
    requestSentDesc: 'विशेषज्ञले उपलब्ध समयमा तपाईंलाई सम्पर्क गर्नेछन्। तपाईं एक्लो हुनुहुन्न।',
    sendAnon: 'नाम लुकाउनुहोस्',
  },
};
