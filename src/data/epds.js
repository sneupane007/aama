...
// 10 validated questions, masked as general wellness inquiries
...
export const epdsQuestions = [
  {
    ...
    maskedLabel: { en: 'How is your mood and enjoyment?', ne: 'तपाईंको मनोदशा र आनन्द कस्तो छ?' },
    options: [
  ...
  },
  {
    ...
    maskedLabel: { en: 'How do you feel about upcoming activities?', ne: 'आगामी गतिविधिहरूको बारेमा कस्तो लाग्छ?' },
    options: [
  ...
  },
  {
    ...
    maskedLabel: { en: 'How do you handle difficult situations?', ne: 'कठिन परिस्थितिलाई कसरी सामना गर्नुहुन्छ?' },
    options: [
  ...
  },
  {
    ...
    maskedLabel: { en: 'How has your general stress been?', ne: 'तपाईंको सामान्य तनाव कस्तो छ?' },
    options: [
  ...
  },
  {
    ...
    maskedLabel: { en: 'Have you felt uneasy or nervous recently?', ne: 'के तपाईं हालै अशान्त वा घबराउनुभयो?' },
    options: [
      { en: 'No, not at all', ne: 'होइन, बिल्कुल पनि', score: 0 },
  ...
  },
  {
    ...
    maskedLabel: { en: 'How are you managing daily responsibilities?', ne: 'दैनिक जिम्मेवारी कसरी सम्हाल्दै हुनुहुन्छ?' },
    options: [
  ...
  },
  {
    ...
    maskedLabel: { en: 'How has your sleep been?', ne: 'तपाईंको निद्रा कस्तो छ?' },
    options: [
      { en: 'No, not at all', ne: 'होइन, बिल्कुल पनि', score: 0 },
      { en: 'Not very often', ne: 'धेरै कम', score: 1 },
      { en: 'Yes, sometimes', ne: 'हो, कहिलेकाहीं', score: 2 },
  ...
  },
  {
    ...
    maskedLabel: { en: 'How would you describe your emotional state?', ne: 'तपाईंको भावनात्मक अवस्था कस्तो छ?' },
    options: [
      { en: 'No, not at all', ne: 'होइन, बिल्कुल पनि', score: 0 },
      { en: 'Not very often', ne: 'धेरै कम', score: 1 },
  ...
  },
  {
    ...
    maskedLabel: { en: 'Have you felt overwhelmed emotionally?', ne: 'के तपाईं भावनात्मक रूपमा भारी महसुस गर्नुभयो?' },
    options: [
      { en: 'No, never', ne: 'होइन, कहिल्यै पनि', score: 0 },
  ...
  },
  {
    ...
    maskedLabel: { en: 'Have you had any thoughts about your safety?', ne: 'के तपाईंको सुरक्षाको बारेमा कुनै विचार आयो?' },
    options: [
